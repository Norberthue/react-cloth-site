...
export default function info() {
    ...
    className='flex flex-col sm:flex-row justify-between   p-5 sm:p-[50px]'>
        <div className='mb-5'>
            ...
            <p className='text-lg'>info@ucggear.com</p>
        </div>
        <div className='flex-col  basis-7/12'>
            <div className='mb-10'>
                ...
                <div className=' text-lg '>
                    <span className='mb-5 line-clamp-5 '>Purchases from ucggear.com are eligible for return within 30 days of delivery. The customer pays for the shipping back to our warehouse.</span>
                    ...
                    Refunds will be credited to the credit card used to purchase the item, once it has arrived in our warehouse. If you require any help with your return, contact us at info@ucggear.com
                </div>
            </div>
            <div className='mb-10'>
                <h1 className='font-semibold text-2xl'>Shipping</h1>
                <p className='text-2xl'>- - - - - -</p>
                <p className='text-lg '><span className='mb-5 line-clamp-5'>All Ucg Gear orders are shipped from Borås, Sweden via UPS Worldwide.</span>
                    ...
                    <span className='mb-5 line-clamp-5'>For all destinations outside of the EU, customers may face import and duty taxes. These vary from country to country and Ucg Gear has no control over them. In the event that you need to pay import and duty taxes, you will be contacted directly by the shipping service and the order will not be released until you have paid. Please contact your local customs office for further details of charges.</span>

                    <span className='mb-5 line-clamp-5'>In the case that UPS is unable to deliver a package due to an incorrect address entered by the customer, multiple failed attempts to reach the customer by phone number (required at purchase) at point of delivery or otherwise, Ucg Gear is not responsible for payment of return shipping costs levied by the courier.</span>

                    <span className='mb-5 line-clamp-5'>Similarly, Ucg Gear is not responsible for the payment of re-shipping merchandise to the customer. In cases such as these, the customer is responsible for all shipping costs associated with returned packages due to failed delivery.</span>

                    <span className='mb-5 line-clamp-5'>Ucg Gear is not responsible for unexpected shipping delays caused by circumstances such as severe weather or natural disasters. Similarly, we are not responsible for unexpected shipping delays caused by circumstances related to the courier itself, such as clearance delays. Similarly, Ucg Gear is not responsible for theft of packages.</span>
            ...
            <div>
                ...
                <p className='text-2xl'>- - - - - -</p>
                <p className='text-lg'>
                    Ucggear.com and it's content is owned and operated by YEAR0001 AB, Krukmakargatan 36, 118 51, Stockholm, Sweden. All rights reserved.
                </p>
            </div>
