    ...
    <div className='flex flex-col sm:flex-row justify-between   p-5 sm:p-[50px]'>
        ...
        <div className='flex-col  basis-7/12'>
            <div className='mb-10'>
                ...
                <p className='text-2xl'>- - - - - -</p>
                <div className=' text-lg'><span className='mb-5 line-clamp-5'>Purchases from sadboysgear.com are eligible for return within 30 days of delivery. The customer pays for the shipping back to our warehouse.</span>
