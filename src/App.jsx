    ...
    <div>
        ...
        className={`duration-500 trasfrom transition-transform ${statusTabCart === false ? '' : '-translate-x-80 blur-md'}   ${isMenuOpen === false ? '' : 'translate-x-full'}  ${isFollowOpen === false ? '' : 'translate-y-10'}`}>
          ...
          <div className={`${hidden ? 'hidden' : 'block'}  duration-500 relative`}>
              ...
              className='absolute motion-preset-pop   top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 2xl:w-[900px]' version="1.1" id="Lager_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 499.8 331" xmlSpace="preserve">
